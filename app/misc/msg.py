...
MAIN_MSG = (
    "* Главное меню *\n"
    f"\n{cmd.USER_MENU_TXT} - управление данными пользователя.\n"
    f"\n{cmd.AUTO_MENU_TXT} - управление данными своих автомобилей."
)
NO_DATA_MSG = (
...
USER_MSG = (
    "* Мои данные *\n"
    f"\n{cmd.ADD_TXT} свои контактные данные в базу данных бота.\n"
    f"\n{cmd.DELETE_TXT} свои контактные данные и автомобили из базы данных."
)
...
def autos_msg(autos: list[Auto] | None) -> str:
    ...
    return (
        "* Мои автомобили *\n"
        f"\n{cmd.ADD_TXT} данные автомобиля в базу данных.\n"
        f"\n{cmd.DELETE_TXT} данные автомобиля из базы данных.\n"
        "----------\n" + text
    )
